[Home](/) • [LinkedIn](https://www.linkedin.com/in/lucaserodrigues/) • [Email](mailto:lucas.e.rodrigues1@gmail.com) • [CV](https://github.com/Lucas-E-Rodrigues/lucas-e-rodrigues.github.io/raw/main/Resume_LRodrigues(1-21-25).pdf)
...
<img src="/assets/img/AdhesiveCollage.png"
     ...
     style="width:100%; max-width:900px; height:auto; border-radius:5px; border:1px solid #e6e6e6; margin:12px 0 28px 0;">
...
**Skills:** Analog signal conditioning, active filters, single-supply op-amp design, comparator hysteresis, instrumentation/testing, iterative debugging, technical reporting.

**Results:** Measured ~2.662 V DC offset with ~40 mVpp heartbeat ripple at the sensor output :contentReference[oaicite:0]{index=0}; verified filter performance (HP cutoff 40.77 BPM, LP cutoff 217.26 BPM) :contentReference[oaicite:1]{index=1}; iterated the cascade to achieve an overall 40.46–200.34 BPM band-pass response :contentReference[oaicite:2]{index=2}; confirmed clean digital pulses + LED indication with ~4.4804 Vpp output :contentReference[oaicite:3]{index=3}.
